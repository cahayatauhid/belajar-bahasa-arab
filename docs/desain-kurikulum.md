...
Dokumen ini menetapkan landasan paket pembelajaran: audiens, prasyarat, asumsi, prinsip pedagogis, dan posisi terhadap pendekatan lain. Konten paket (textbook, workbook, slides) diturunkan dari dokumen ini.

## Audiens Target

Bapak/ibu profesional Indonesia, dewasa, Muslim, tanpa background pesantren atau studi Islam formal. Termasuk pekerja kantoran dan ibu rumah tangga. Karakteristik yang membentuk desain:

- Waktu belajar terbatas (kerja, keluarga) — pacing harus realistis
- Terbiasa belajar konseptual dan analitis dari pekerjaan/pendidikan formal
- Motivasi intrinsik tinggi (memahami Quran, hadits, dan kitab) tetapi rentan menyerah jika kurva awal terasa kanak-kanak atau tidak relevan
- Tidak punya tradisi pesantren — penjelasan harus mandiri, tidak bergantung pada budaya halaqah

## Prasyarat

Peserta **harus** sudah:

- Bisa membaca Al-Qur'an dengan tajwid: makharijul huruf, sifat huruf, dan hukum mad sudah dikuasai
- Bisa mengenali bentuk huruf hijaiyah dalam ayat (walau belum bisa memisahkan kata per kata)

Peserta **tidak perlu**:

- Pernah belajar bahasa Arab sebelumnya
- Pernah belajar di pondok atau majlis ilmu
- Bisa menulis huruf Arab dari nol (akan diajarkan dalam paket)
- Tahu makna ayat atau dzikir yang sering dibaca
- Menguasai bahasa asing selain Indonesia (Inggris membantu untuk analogi grammar, tapi bukan prasyarat)

## Asumsi

- Native speaker Bahasa Indonesia
- Pemahaman dasar grammar Bahasa Indonesia (subjek, predikat, kata benda, kata kerja) dari pendidikan SMA
- Familier dengan beberapa konsep grammar Inggris (tense, possessive, article) — opsional, dipakai sebagai analogi pendukung
- Mode pembelajaran: classroom dengan pengajar + PR mandiri
- Tujuan akhir: pemahaman tertulis, **bukan** kemampuan percakapan

## Tujuan Pembelajaran

Paket ini dirancang sebagai program berjenjang. Tujuan akhir setelah seluruh level selesai:

1. **Reading comprehension penuh** — bisa membaca dan memahami Al-Qur'an dengan terjemahan kata per kata, hadits panjang dengan i'rab, serta kitab ulama klasik tanpa bantuan terjemahan
2. **Writing proficiency produktif** — bisa menulis paragraf dan esai singkat dalam bahasa Arab fusha dengan grammar yang benar, termasuk meringkas kitab klasik (mis. *Al-Jurumiyyah*, *Tsalatsatul Ushul*, *Qotrun Nada*) dalam bahasa Arab sendiri
3. **Listening comprehension** — bisa mendengarkan dan memahami ceramah, durus, dan khutbah dari syeikh dalam bahasa Arab fusha tanpa bantuan terjemahan
4. **Tata bahasa lengkap** — menguasai i'rab tingkat menengah (setara cakupan *Qotrun Nada*) dan mampu menerapkannya dalam i'rab maupun penyusunan kalimat

Kemampuan percakapan tidak menjadi tujuan paket ini. Listening bersifat satu arah (memahami pembicara), bukan dialogis.

Korpus target akhir: Al-Qur'an, hadits dari kitab utama (Bukhari, Muslim, Arba'in, Riyadush Shalihin), kitab pemula sampai menengah (*Akhlak lil-Banin*, *Tsalatsatul Ushul*, *Al-Jurumiyyah*, *Qotrun Nada*, *Alfiyah Ibn Malik*), serta rekaman ceramah dan durus berbahasa Arab fusha dari ulama kontemporer.

Tujuan akhir ini tidak tercapai dalam satu level — pembagian per level dijabarkan di bagian Roadmap.

## Prinsip Pedagogis

1. **Grounding pada bahasa native.** Setiap konsep gramatikal Arab dijelaskan dalam Bahasa Indonesia dan didampingi analogi dari grammar Indonesia dan Inggris. Tidak ada lompatan ke istilah teknis tanpa jembatan.
2. **Sequential dan eksplisit.** Konsep diperkenalkan satu per satu dengan urutan logis dan bimbingan bertahap yang eksplisit, bukan diserap dari konteks percakapan. Dewasa pemula belajar lebih cepat dengan struktur yang nampak.
3. **Latihan tertulis intensif.** Setiap pelajaran punya PR berisi drill pemisahan kata, terjemah, i'rab, dan menulis. Tujuan tertulis dicapai dengan latihan tertulis.
4. **Korpus klasik sejak awal.** Setiap pelajaran memuat catatan singkat menunjukkan konsep yang baru dipelajari muncul di ayat Quran atau matan hadits — agar peserta merasakan relevansi langsung.
5. **Kosakata netral terlebih dahulu.** Vocabulary inti dimulai dari kata-kata netral (bayt, qalam, kursi, kitab, masjid) dan diakumulasi bertahap dengan teknik Madinah method. Kosakata Quran/hadits dan istilah teknis matn klasik diperkenalkan bertahap, bukan front-loaded.
6. **Tone teknis dan dewasa.** Tidak menggunakan bahasa kanak-kanak, ilustrasi yang infantilizing, atau penjelasan yang merendahkan kecerdasan peserta.
7. **Menyeluruh dulu, baru mendalam.** Level 1 menyurvei seluruh peta nahwu dan shorf dasar agar peserta bisa mengenali struktur kalimat normal sejak dini. Detail, perkecualian, dan kasus khusus diserahkan ke level berikutnya. Filosofinya: peserta lebih cepat fungsional ketika seluruh peta sudah dimiliki di tingkat overview, daripada satu topik dikuasai sempurna sementara kategori lain belum diketahui.

## Pendekatan: Referensi Klasik dengan Delivery Modern
...
Sequence pedagogis tidak mengikuti urutan matn aslinya, karena urutan Jurumiyyah bersifat referensial-kategorikal (definisi → marfu'at → manshubat → majrurat) yang abstrak untuk pemula nol-background. Sebagai gantinya, materi disusun ulang secara bertahap: konsep prasyarat dulu, baru bagian matn yang relevan dibaca dan disyarah.

*Delivery* dimodifikasi untuk audiens dewasa pemula:

| Aspek                | Pengajaran Klasik (Pesantren)                       | Paket Ini                                                                  |
|----------------------|-----------------------------------------------------|----------------------------------------------------------------------------|
...
### Pendekatan Percakapan (Communicative)
...
- Tidak menyiapkan untuk meng-i'rab kalimat klasik, yang dibutuhkan untuk membaca kitab

### Pendekatan Pesantren Tradisional
...
- Memerlukan pengajar yang menguasai metode klasik secara langsung

Walau begitu, sebagian referensi gramatikal pesantren akan dipakai sebagai sumber sekunder untuk istilah baku (mis. nama-nama bab i'rab).
...
- Sequence pedagogis: simple-to-complex dengan banyak repetisi struktur

Posisi dalam paket ini: **bukan backbone konten**, melainkan *sumber teknik delivery*. Akumulasi vocabulary bertahap, struktur drill produktif, dan pacing yang ramah dewasa pemula diadopsi karena terbukti efektif. Otoritas dan urutan topik gramatikal tetap mengacu pada matn klasik (Jurumiyyah, Qotrun Nada), bukan ke struktur Buku Madinah.

## Roadmap Multi-Level

Paket dirancang berjenjang dengan filosofi *menyeluruh dulu, baru mendalam*: Level 1 melingkupi peta lengkap gramatikal Arab di tingkat overview agar peserta sejak dini bisa mengenali struktur kalimat normal. Level berikutnya mendalami detail, kasus khusus, dan perkecualian per topik, sambil memperluas korpus bacaan dan keterampilan produktif. Penjenjangan juga diperlukan karena tujuan akhir — terutama menulis ringkasan kitab klasik dalam bahasa Arab fusha — tidak realistis dicapai dalam satu level.

Setiap level diorganisir dengan satu *tujuan utama* yang jelas — kemampuan utama yang ditandai dengan kalimat klaim peserta di akhir level. Hasil per kemampuan (reading, writing, listening, tata bahasa) diturunkan dari tujuan utama ini.

### Level 1 — Pondasi: Peta Gramatikal Lengkap

**Tujuan utama**: peserta memiliki kerangka mental lengkap nahwu dan shorf dasar, dan bisa meng-i'rab kalimat Arab normal di Quran, hadits, dan kitab pemula. Sebelum masuk ke teknis, peserta dibekali motivasi belajar bahasa Arab, sejarah ilmu nahwu/shorf, dan pemahaman tentang hubungan Al-Qur'an dengan bahasa Arab.
...
- *Tata bahasa* — peta lengkap nahwu (i'rab + marfu'at + manshubat + majrurat + majzumat + dhamir) + shorf garis besar (wazan dan makna pokok)

**Klaim capaian**: "Saya sudah membaca matn *Jurumiyyah* secara overview, dan punya peta lengkap nahwu serta shorf dasar."

### Level 2 — Penguasaan: Membaca Quran dan Hadits dengan I'rab Detail
...
- *Tata bahasa* — detail lengkap *Jurumiyyah* (asma' al-khamsah, mutsanna, jamak, mu'rab dengan tanda far'i, semua perkecualian) + tashrif fi'il mujarrad + mazid lengkap

**Klaim capaian**: "Saya sudah khataman *Jurumiyyah* dan *Tashrif al-'Izzi*. Bisa meng-i'rab Quran dan hadits panjang secara detail."

### Level 3 — Pendalaman: Membaca Kitab Klasik Pemula

**Tujuan utama**: peserta menguasai paruh pertama *Qotrun Nada* dan shorf i'lal komprehensif. Bisa baca kitab pemula komplit dengan analisis lengkap, dan mulai menulis paragraf bahasa Arab.
...
**Klaim capaian**: "Saya sudah baca *Akhlak lil-Banin* dan *Tsalatsatul Ushul* dengan i'rab. Bisa nulis paragraf Arab. Sudah masuk *Qotrun Nada* paruh pertama."

### Level 4 — Penguasaan: Menulis Ringkasan Kitab dan Memahami Ceramah Ulama

**Tujuan utama**: peserta menguasai *Qotrun Nada* lengkap dan shorf komprehensif. Bisa menulis ringkasan kitab klasik dalam Arab fusha, dan bisa memahami ceramah ulama pada topik klasik.
...
**Klaim capaian**: "Saya sudah khataman *Qotrun Nada* dan *Lamiyyah al-Af'al*. Bisa menulis ringkasan kitab klasik dalam Arab. Bisa memahami ceramah ulama dalam fusha."

### Level 5 — Mahir: Khataman Alfiyah Ibn Malik

**Tujuan utama**: peserta mengkhatamkan *Alfiyah Ibn Malik* sebagai capstone klasik — integrasi nahwu dan shorf tingkat lanjut. Bisa membaca kitab tingkat lanjut (tafsir, syarah hadits, fiqh muqaran) dan memahami durus kitab tingkat menengah-lanjut.
...
- *Tata bahasa* — i'rab tingkat lanjut termasuk kasus klasik dan perkecualian langka

**Klaim capaian**: "Saya sudah khataman *Alfiyah Ibn Malik*. Bisa baca dan memahami kitab tingkat lanjut, dan bisa menulis kitabah tingkat lanjut dalam Arab fusha."

---

Paket Level 1 adalah deliverable pertama. Level 2 sampai 5 dirancang setelah level sebelumnya selesai dan mendapat umpan balik dari iterasi kelas. Level 5 (Alfiyah) dirancang sebagai jenjang mahir untuk peserta yang ingin lanjut ke kapasitas ulama-level — opsional, tidak wajib bagi peserta yang sudah puas dengan kemampuan Level 4.

## Cakupan Paket Level 1
...
Hasil spesifik Level 1:

- **Reading** — bisa meng-i'rab dan menerjemah kalimat Arab normal (ayat Quran sederhana, hadits Arba'in pendek, paragraf kitab pemula) dengan i'rab dasar; sudah membaca seluruh matn *Jurumiyyah* dengan i'rab dipandu (overview, belum semua detail)
- **Writing** — bisa menulis huruf hijaiyah dengan benar (sambung dan terpisah), menulis ulang kosakata, dan menerjemahkan kalimat dari Indonesia ke Arab pada semua kategori dasar (jumlah ismiyyah, fi'liyyah, dengan dhamir dan idhafah)
...
| 1     | Blok 1 --- Pengantar/Motivasi | 1, 2, 3, 4, 5, 6, 7  | 7      | B (1--4), A (5--7)| **Dirilis**    |
...
| 6     | Blok 6 --- Dhamir             | 26, 27, 28           | 3      | A                 | **Dirilis**    |
| 7     | Blok 7 --- Shorf Garis Besar  | 29, 31, 32, 33, 34   | 5      | A (29), C (31--34)| Pending        |

**Total target Level 1**: 34 workbook (29 sudah dirilis = 3 prototipe + 7 Blok 1 + 4 Blok 2 + 6 Blok 3 + 3 Blok 4 + 3 Blok 5 + 3 Blok 6; 5 dalam pipeline). Saat batch baru selesai, roadmap di atas di-update statusnya, dan link unduh ditambahkan di frontpage GitHub Pages.
